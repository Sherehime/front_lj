...
class Login_component extends React.Component {
    render() {
        return (
            ...
            <div className={"gdBFSQ"}>
                <form className={"wrapper-container"} onSubmit={this.props.create_user} >
                    ...
                    <div className={" label-float"} data-validate={"Enter username"}>
                       <input   className={"login_input__form"} id ={"username_input"} type={"text"} name={"username"} placeholder={"Username"}   />

                        <label>Username</label>
                    </div>
                     <div className={"label-float"} data-validate={"Enter password"}>
                        <input  className={"login_input__form"} type={"password"} id ={"password_input"} name={"pass"} placeholder={"Password"}  />
                    ...
                    <div className={"login__forgot_pass"}>
                        <a className={"a-gradient"} >
                            <u> <Link to={"/forgot"}>ЗАБЫЛИ ПАРОЛЬ?</Link></u>
                        </a>
                    </div>
                </form>
            </div>
